...
----
$ git clone git@github.com:rmaddali/rsdemo
...
. Stop your booster.
. Make your change (e.g. edit link:https://github.com/rmaddali/rsdemo/edit/master/src/main/resources/webroot/index.html[`src/main/resources/webroot/index.html`]).
